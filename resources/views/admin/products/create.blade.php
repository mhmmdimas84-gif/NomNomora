...
<div class="flex flex-col gap-6 max-w-4xl">
    <div class="flex flex-col gap-1">
        ...
        <p class="text-gray-500">Tambahkan camilan atau menu baru ke dalam katalog penjualan NomNomora.</p>
    </div>
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-6">
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="price" name="price" value="{{ old('price') }}" required min="0" step="100"
                    ...
                    <div class="flex flex-col md:flex-row gap-6 mt-2">
                        ...
                        <label class="flex items-center gap-3 cursor-pointer">
                            <div class="relative">
                                <input type="checkbox" name="is_featured" value="1" {{ old('is_featured') == '1' ? 'checked' : '' }} class="sr-only peer">
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <textarea id="description" name="description" rows="3" required
                          ...
                          placeholder="Jelaskan produk secara singkat dan menggugah selera (akan ditampilkan pada card produk).">{{ old('description') }}</textarea>
                @error('description')
                    <span class="text-xs text-red-500 font-semibold mt-0.5">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <textarea id="ingredients" name="ingredients" rows="3"
                          ...
                          placeholder="Contoh: Kulit pangsit, crab stick, mayones, keju spread, bumbu seblak kencur... (akan ditampilkan pada halaman detail).">{{ old('ingredients') }}</textarea>
                @error('ingredients')
                    <span class="text-xs text-red-500 font-semibold mt-0.5">{{ $message }}</span>
                @enderror
            </div>
